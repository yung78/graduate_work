...
Под списком файлов расположены кнопки управления файлами открытого аккаунта. Функционал такой же, как у кнопок управления на странице пользователя.
...
Не стал добавлять в админку изменение пароля (при необходимости добавлю на доработке). Так же была идея реализации поиска и фильтрации аккаунтов по различным параметрам(id, email, fullSize), но по времени уже затянул с выполнением и решил оставить по дефолту(id по возрастанию).
